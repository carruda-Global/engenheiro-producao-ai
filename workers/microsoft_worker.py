...
logger = logging.getLogger("microsoft_worker")

TOPIC = "microsoft.tasks"
GROUP_ID = "microsoft-worker-group"
...
async def run_worker() -> None:
    ...
    logger.info("Microsoft Worker iniciado — consumindo topico: %s", TOPIC)
