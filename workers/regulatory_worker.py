...
logger = logging.getLogger("regulatory_worker")

TOPIC = "regulatory.tasks"
GROUP_ID = "regulatory-worker-group"
...
async def run_worker() -> None:
    ...
    logger.info("Regulatory Worker iniciado — consumindo topico: %s", TOPIC)
