...
AGENT_IDS = {
    ...
    "#37": "agentforce_sdr", "#38": "agentforce_field_service", "#39": "agentforce_contracts",
    "#40": "agentforce_revenue", "#41": "agentforce_sustainability",
    "#42": "oracle_erp_compliance", "#43": "oracle_hcm_regulatory", "#44": "oracle_supply_chain_esg",
    "#45": "oracle_cx_sales",
    "#46": "sap_compliance_bridge", "#47": "sap_predictive_maintenance", "#48": "sap_cbam_export",
